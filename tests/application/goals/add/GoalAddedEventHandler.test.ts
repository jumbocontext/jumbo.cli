...
import { GoalAddedEventHandler } from "../../../../src/application/goals/add/GoalAddedEventHandler";
import { IGoalAddedProjector } from "../../../../src/application/goals/add/IGoalAddedProjector";
