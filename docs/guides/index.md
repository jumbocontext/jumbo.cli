---
title: Guides
description: Deep-dive tutorials for common Jumbo workflows — setup, execution, migration, and advanced multi-agent operation.
sidebar:
  order: 2
---
...
| Guide | Description |
|-------|-------------|
| [Project Initialization](project-initialization.md) | Configure Jumbo for your project |
