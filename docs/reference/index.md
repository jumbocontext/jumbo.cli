...
| Section | Description |
|---------|-------------|
| [Commands Index](commands/index.md) | Directory of all command groups and subcommands |
| [Goal Commands](commands/goal.md) | goal lifecycle and workflow orchestration commands |
| [Session Commands](commands/session.md) | session start, end, list, and compact |
| [Project Commands](commands/project.md) | init, update |
